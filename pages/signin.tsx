      ...
      <div className="flex flex-col justify-between max-w-lg p-3 m-auto w-80">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <span className="pt-1 text-center text-sm">
            <a
              ...
              {`Sign in with a ${signUpUsingPassword ? 'magic link' : 'password'}`}
            </a>
          </span>
        ...
        <div className='flex flex-col justify-center items-center'>
          <Button
            type="button"
            loading={false}
            className='uppercase text-center text-sm my-4 px-12 py-2 font-bold rounded-md bg-gradient-to-r bg-gray-300 text-black disabled:opacity-50 flex justify-center items-center'
            disabled={false}
            onClick={async () => {
